...
SELECTED_FEATURES = ['sign_log_return_lag1_ETHUSDT', 'momentum_ETHUSDT', 'rsi_ETHUSDT', 'volatility_ETHUSDT', 'volatility_BTCUSDT', 'close_ETHUSDT_lag1', 'close_BTCUSDT_lag1', 'hour_of_day', 'close_SOLUSDT_lag30', 'close_BTCUSDT_lag30', 'close_ETHUSDT_lag30']
REQUIRED_FEATURES = ['sign_log_return_lag1_ETHUSDT', 'momentum_ETHUSDT', 'rsi_ETHUSDT', 'volatility_ETHUSDT', 'close_ETHUSDT_lag1', 'hour_of_day']
...
def get_performance_summary(rmse, mztae, directional_acc=None, correlation=None):
    ...
    summary = []
    summary.append(f'Performance Summary for Competition 22:')
    summary.append(f"{'=' * 50}")
